...
class RankingWeights:
    ...
    tf_idf: float = 0.35
    pagerank: float = 0.20
    domain_authority: float = 0.15
    recency: float = 0.10
    keyword_density: float = 0.08
    link_structure: float = 0.07
    regional_relevance: float = 0.05


class RankingCore:
    """Main ranking orchestrator that combines multiple ranking factors"""
