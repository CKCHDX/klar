...
# (str) Package name
package.name = klarbrowser

# (str) Package domain (needed for android/ios packaging)
package.domain = org.kse
...
requirements = python3,kivy==2.2.1,requests==2.31.0,certifi
...
android.presplash_color = #1a1a1f
...
# 1) android.add_assets = source.dir/assets/some_file.png
# 2) android.add_assets = path/to/directory
#android.add_assets =
...
# android.add_resources = legal_icons:icon.png
# 2) A directory, here  'legal_resources' must contain resources of one kind
# android.add_resources = legal_resources:drawable
# 3) A directory or multiple directories, using Android style resources layout
