...
/* ===== FORCE LABEL VISIBILITY IN ALL CONTEXTS ===== */
QLabel {{
    color: {colors['text_primary']};
    background-color: transparent;
}}
...
/* ===== FORCE VISIBILITY IN CONTROL CENTER ===== */
QWidget[objectName^="control_"] * {{
    color: {colors['text_primary']};
}}

QFrame[objectName^="control_"] {{
    background-color: {colors['bg_secondary']};
    color: {colors['text_primary']};
}}

/* ===== STATUS INDICATORS FORCE VISIBILITY ===== */
QLabel[class="status"] {{
    font-weight: bold;
