...
class ControlCenterConfig:
    ...
    # API configuration
    # Dynamically load from KSE config or environment variable
    # Priority: 1) KSE_SERVER_URL env var, 2) kse_config.yaml public_url, 3) localhost fallback
    @staticmethod
    def _get_api_base_url():
        ...
        try:
            ...
            # Convert 0.0.0.0 to localhost for GUI
            if host == "0.0.0.0":
                host = "localhost"
    ...
    API_BASE_URL = _get_api_base_url.__func__()
