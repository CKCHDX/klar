...
- **APK (Optional)**: Built manually via workflow dispatch (experimental)
...
The APK build is only triggered via manual workflow dispatch and is experimental since PyQt6 has limited Android support.
